...
<form action="/customers/add" method="post">
  ...
  * <input type="text" name="name" placeholder="" id="name" required> <br />
  ...
  <input type="text" name="INN" placeholder="" id="INN"> <br />

  <label for="OGRN"> ОГРН: </label>
  <input type="text" name="OGRN" placeholder="" id="OGRN"> <br />
  ...
  <input type="text" name="KPP" placeholder="" id="KPP"> <br />

  <label for="OKPO_code"> ОКПО: </label>
  <input type="text" name="OKPO_code" placeholder="" id="OKPO_code"> <br />

  <label for="OKFC_code"> ОКФС: </label>
  <input type="text" name="OKFC_code" placeholder="" id="OKFC_code">

  <label for="OKOPF_code"> ОКОПФ: </label>
  <input type="text" name="OKOPF_code" placeholder="" id="OKOPF_code"> <br />
  ...
  <input type="text" name="payment_account" placeholder="" id="payment_account"> <br />

  <label for="correspondent_account"> Корреспондентский счет: </label>
  <input type="text" name="correspondent_account" placeholder="" id="correspondent_account"> <br />

  <label for="BIK"> БИК: </label>
  <input type="text" name="BIK" placeholder="" id="BIK"> <br />
