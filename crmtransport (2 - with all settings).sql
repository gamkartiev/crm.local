...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Окт 28 2023 г., 23:55
...
CREATE TABLE `checks` (
  ...
  `sum` int(11) NOT NULL COMMENT 'Сумма чека',
  `date` date NOT NULL,
  `note` varchar(255) NOT NULL,
  `id_status` int(11) NOT NULL,
  `availability_of_a_check` varchar(11) NOT NULL COMMENT 'наличие чека'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `checks` (`id`, `id_drivers`, `sum`, `date`, `note`, `id_status`, `availability_of_a_check`) VALUES
(4, 47, 4000, '2023-02-10', 'запчасти', 1, 'Есть'),
(5, 47, 1000, '2023-02-17', 'автомойка', 1, 'Есть'),
(6, 47, 500, '2023-02-28', 'шиномонтаж', 2, 'Нет');
...
--
-- Структура таблицы `drivers_other_works`
--

CREATE TABLE `drivers_other_works` (
  `id` int(11) NOT NULL,
  `id_drivers` int(11) NOT NULL,
  `sum` int(11) NOT NULL,
...
--
-- Дамп данных таблицы `drivers_other_works`
--

INSERT INTO `drivers_other_works` (`id`, `id_drivers`, `sum`, `date_of_work`, `id_status`, `note`) VALUES
(1, 47, 4000, '2023-02-05', 2, 'тестовое'),
(2, 1, 500, '2023-02-01', 1, ''),
(3, 47, 101, '2023-02-07', 1, '');
...
(11, 47, '1222888484500 от 02.01.2022', '2023-02-17', '12:00:00', 6, '2023-03-22', 250, 250, '2023-03-27', 500, '2023-03-27', '---', 2);

-- --------------------------------------------------------

--
-- Структура таблицы `fines_other`
--

CREATE TABLE `fines_other` (
  `id` int(11) NOT NULL,
  `id_drivers` int(11) NOT NULL,
  `sum` int(11) NOT NULL,
  `date` date NOT NULL,
...
--
-- Дамп данных таблицы `fines_other`
--

INSERT INTO `fines_other` (`id`, `id_drivers`, `sum`, `date`, `note`) VALUES
(6, 1, 0, '2023-02-01', ''),
(7, 46, 0, '2023-02-01', ''),
(8, 47, 0, '2023-02-01', ''),
(9, 1, 600, '2023-01-22', ''),
(10, 47, 700, '2023-01-01', 'тест2');
...
(18, 1, '2023-02-01', '07.01.2023, 14.01.2023, 21.01.2023', 800),
(19, 46, '2023-02-01', '22.01.2023', 300),
(28, 1, '2023-01-01', '', 0),
(29, 47, '2023-01-01', '04.01.2023', 700);
...
ALTER TABLE `checks`
  ...
  ADD KEY `availability_of_a_check` (`availability_of_a_check`);
...
--
-- Индексы таблицы `drivers_other_works`
--
ALTER TABLE `drivers_other_works`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id_drivers` (`id_drivers`),
...
--
-- Индексы таблицы `fines_other`
--
ALTER TABLE `fines_other`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id_drivers` (`id_drivers`);
...
--
-- AUTO_INCREMENT для таблицы `drivers_other_works`
--
ALTER TABLE `drivers_other_works`
...
--
-- AUTO_INCREMENT для таблицы `fines_other`
--
ALTER TABLE `fines_other`
...
--
ALTER TABLE `checks`
  ADD CONSTRAINT `checks_ibfk_1` FOREIGN KEY (`id_drivers`) REFERENCES `drivers` (`id`),
  ADD CONSTRAINT `checks_ibfk_3` FOREIGN KEY (`id_status`) REFERENCES `configuration` (`id`);

--
-- Ограничения внешнего ключа таблицы `drivers_other_works`
--
ALTER TABLE `drivers_other_works`
  ADD CONSTRAINT `drivers_other_works_ibfk_1` FOREIGN KEY (`id_drivers`) REFERENCES `drivers` (`id`),
  ADD CONSTRAINT `drivers_other_works_ibfk_2` FOREIGN KEY (`id_status`) REFERENCES `configuration` (`id`);
...
--
-- Ограничения внешнего ключа таблицы `fines_other`
--
ALTER TABLE `fines_other`
  ADD CONSTRAINT `fines_other_ibfk_1` FOREIGN KEY (`id_drivers`) REFERENCES `drivers` (`id`);
